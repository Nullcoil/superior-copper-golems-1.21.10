...
{
    private static final File configFile = FabricLoader.getInstance().getConfigDir().resolve(SuperiorCopperGolems.MOD_ID + "-config.json").toFile();
    ...
    public static void init()
    {
        ...
        {
            SuperiorCopperGolems.LOGGER.error("Error loading config", e);
